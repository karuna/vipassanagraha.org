<?php
/**
 * @version		3.0.94 buttons/import12.php
 * @package		J2XML
...
class JToolbarButtonImport12 extends JToolbarButton
{
	/**
	 * Button type
	 *
	 ...
	 * @since   3.0
	 */
	public function fetchButton($type='Import12', $name = '', $text1 = '', $text2 = '', $task = 'import', $list = true)
//	public function fetchButton($type = 'Import', $name = '', $text = '', $task = '', $list = false)
	 ...
	 * @since   3.0
	 */
	public function fetchId($type = 'Import12', $name = '', $text = '', $task = '', $list = true, $hideMenu = false)
	{
