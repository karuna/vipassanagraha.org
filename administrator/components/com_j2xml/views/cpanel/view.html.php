<?php
/**
 * @version		3.0.95 models/cpanel/view.html.php
 * 
 * @package		J2XML
...
class J2XMLViewCPanel extends JViewAbstract
{
	...
	protected function addToolbar()
	{
		...
		if (version_compare(JPlatform::RELEASE, '12', '<'))
		{
			...
			$toolbar->loadButtonType('Import12', true);
		
		
		JToolBarHelper::title(JText::_('COM_J2XML_TOOLBAR_J2XML'), 'j2xml.png');
		if ($canDo->get('core.create') || ($canDo->get('core.edit'))) {
			$toolbar->appendButton('Import'.(version_compare(JPlatform::RELEASE, '12', '>=') ? '12' : ''), 'j2xml', 'COM_J2XML_BUTTON_OPEN', 'COM_J2XML_BUTTON_IMPORT', 'cpanel.import');
